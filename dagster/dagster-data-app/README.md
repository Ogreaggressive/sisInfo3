...
You can start writing assets in `dagster_data_app/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `dagster_data_app_tests` directory and you can run tests using `pytest`:

```bash
pytest dagster_data_app_tests
```
